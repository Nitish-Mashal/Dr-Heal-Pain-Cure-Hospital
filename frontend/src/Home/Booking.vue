            ...
            <div class="row items-center">
                ...
                <div class="col-md-7 mt-4 flex flex-col justify-center">
                    ...
                    <div class="grid grid-cols-2 gap-x-12 gap-y-6">
                        ...
                        <!-- LEFT INFO -->
                        <div>
                            <div class="bg-color-orange w-10 h-10 flex items-center justify-center rounded-full">
                            ...
                            <p class="text-2xl font-semibold mt-3">Visit Us On</p>

                            <p class="mt-2 text-gray-700">
                                392, Ganapa Arcade, 9th Main Road, 7th Sector, HSR Layout, Bengaluru – 560102
                            </p>

                            <p class="mt-2">
                                <a href="https://www.google.com/maps?q=DR+HEAL+PAIN+CURE+HOSPITALS+HSR+Layout+Bangalore"
                                    target="_blank" class="inline-flex items-center gap-2 text-gray-900">
                                    Open in Map
                        ...
                        <div>
                            ...
                            <p class="text-2xl font-semibold mt-3">Contact Us</p>
                            ...
                            <div class="mt-3">
                                <a href="mailto:info@drheal.in"
                                    class="inline-flex items-center gap-2 text-gray-900 hover:underline">
                                    info@drheal.in
                                </a>
                            </div>
                        </div>
