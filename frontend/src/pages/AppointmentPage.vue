...
<div class="flex justify-center items-center gap-4 mb-6 relative">
  ...
  <!-- Date pill -->
  <div
    class="px-6 py-2 rounded-full bg-green-100 text-green-700 font-semibold
...
<!-- No slots -->
<p
  v-if="!isFetchingSlots && availableTimes.length === 0"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
          ...
          <div class="flex flex-col">
            ...
            >
              ...
              <option
                v-for="t in appointment_types"
                :key="t.name"
                :value="t.appointment_type"
              >
                {{ t.appointment_type }}
              </option>
            </select>
